...
const styles = StyleSheet.create({
  ...
  emptyActivitiesText: {
    ...
    fontWeight: '400',
        ...
        <View style={styles.analyticsCard}>
          <View style={styles.analyticsRight}>
            <ActivityWheel activities={mockActivities} size={200} />
            <Text style={styles.wheelTimeLabel}>12 PM</Text>
          </View>
          ...
          <View style={styles.analyticsLeft}>
            ...
            <Text style={styles.totalTrackedLabel}>Total Tracked</Text>
            <Text style={styles.totalTrackedValue}>
              {Math.floor(totalTrackedMinutes)}h {Math.round(totalTrackedMinutes % 1 * 60)}m
            </Text>

            <View style={styles.legendContainer}>
              {uniqueActivities.map((activity) => (
                <View key={activity.name} style={styles.legendItem}>
                  <View
                    style={[
                      styles.legendDot,
                      { backgroundColor: getActivityColor(activity.name) },
                    ]}
                  />
                  <Text style={styles.legendLabel}>{activity.name}</Text>
                  <Text style={styles.legendValue}>{activity.totalMinutes}m</Text>
                </View>
              ))}
            </View>
          </View>
        ...
        <View style={styles.activitiesSection}>
          ...
          <View style={styles.activitiesListContainer}>
            {activitiesWithDuration.map((activity, idx) => (
              <TouchableOpacity key={activity.id} style={styles.activityListItem}>
                <ActivityIcon activityName={activity.text} />
                <View style={styles.activityListContent}>
                  <Text style={styles.activityListName}>{activity.text}</Text>
                  <Text style={styles.activityListTime}>
